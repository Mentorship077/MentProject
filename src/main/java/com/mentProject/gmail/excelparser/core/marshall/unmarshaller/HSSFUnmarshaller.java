...
import com.mentProject.gmail.excelparser.core.exception.ModelInstantiationException;
...
import static com.mentProject.gmail.excelparser.core.utils.ExcelFileUtils.getActualRowCount;
import static com.mentProject.gmail.excelparser.core.utils.ExcelFileUtils.skip;


public class HSSFUnmarshaller extends Unmarshaller {


    private final MarshallOptions options;
    private final HSSFWorkbook workbook;
    private Logger LOG = Logger.getLogger(HSSFUnmarshaller.class);


    HSSFUnmarshaller(HSSFWorkbook workbook, MarshallOptions options) {
